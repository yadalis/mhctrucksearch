                            ...
                            if sf.userAction then 
                                ...
                                [
                                    column[][
                                        ...
                                        el [bw 0, Font.size 16, brc 97 97 97, fc  190 5 30,  bc 231 231 231 ,pd 6, Font.light] (textValue <| sf.searchFilterKey)
                                    ]
                                    ,column[][
                                        Input.button ( [ hf, bw 0, brc 97 97 97,  bc 231 231 231 ,pd 6])
                                        { 
