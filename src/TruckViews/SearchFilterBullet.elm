    ...
    filterList
        |> Array.map (\sf -> --el [bw 1, brc 185 185 185,  bc 195 195 195,pd 3] (
                            if sf.userAction then 
                                ...
                                [
                                    column[][
                                        el [bw 1, brc 175 175 175, Font.color <| rgb255 244 69 66,  bc 215 215 215,pd 3, Font.light] (textValue <| sf.searchFilterKey)
                                    ]
                                    ,column[][

                                                    Input.button ( [ hf, eId "X",bw 1, brc 185 185 185,  bc 195 195 195,pd 3])
                                                    { 
