												...
												return function (year) {
													return function (primaryImageLink) {
														return function (truckType) {
															return {appraisalNumber: appraisalNumber, apu: apu, cdl: cdl, condition: condition, id: id, make: make, model: model, name: name, poNumber: poNumber, price: price, primaryImageLink: primaryImageLink, stockNumber: stockNumber, title: title, truckType: truckType, year: year};
														};
													};
												};
											};
...
var author$project$Commands$fetchTrucks = elm$http$Http$get(
	{
		...
		url: author$project$Commands$fetchTrucksUrl
	});
var author$project$Model$initalUIModel = {filterCDLNoSelected: false, filterCDLYesSelected: false};
var krisajenkins$remotedata$RemoteData$Loading = {$: 'Loading'};
var author$project$Model$initialModel = {textVal: 'Init Model', truckList: elm$core$Array$empty, trucks: krisajenkins$remotedata$RemoteData$Loading};
...
var author$project$Msg$UnwrapWebDataTrucks = {$: 'UnwrapWebDataTrucks'};
...
var author$project$Main$update = F2(
	function (msg, _n0) {
		...
		switch (msg.$) {
			...
			case 'UnwrapWebDataTrucks':
				var decodedTrucks = function () {
					var _n2 = model.trucks;
					switch (_n2.$) {
						case 'NotAsked':
							return elm$core$Array$empty;
						case 'Loading':
				...
				return _Utils_Tuple2(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{truckList: decodedTrucks}),
						uiModel),
					elm$core$Platform$Cmd$none);
			case 'FilterCDLNoCheckBoxClicked':
				...
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							uiModel,
							{filterCDLNoSelected: userAction})),
					elm$core$Platform$Cmd$none);
			default:
				var userAction = msg.a;
				return _Utils_Tuple2(
					_Utils_Tuple2(
						...
						_Utils_update(
							uiModel,
							{filterCDLYesSelected: userAction})),
					elm$core$Platform$Cmd$none);
		}
	});
				...
				[
					...
					_Utils_ap(
						...
						elm$core$String$fromInt(
							elm$core$Array$length(model.truckList))))
				])));
};
